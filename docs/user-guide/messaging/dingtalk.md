---
layout: docs
title: "Messaging_Dingtalk"
permalink: /docs/user-guide/messaging/dingtalk/
---
...
- group_sessions_per_user: truekeeps each participant's context isolated inside shared group chats
- require_mention: trueprevents the bot from responding to every group message — it only answers when someone @-mentions it
- allowed_usersunderdingtalk.extrais an alternative toDINGTALK_ALLOWED_USERS; if both are set, they're merged
...
- AI Cards: Optionally reply with rich AI Cards instead of plain markdown. Configure viacard_template_id.
